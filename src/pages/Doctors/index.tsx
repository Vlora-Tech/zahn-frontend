...
// Mobile card renderer for doctors
const DoctorMobileCard = ({ doctor }: { doctor: Doctor }) => {
  return (
    <Box>
      <Typography
        variant="subtitle1"
...
const Doctors = () => {
  ...
  const mobileCardRenderer = (doctor: Doctor) => (
    <DoctorMobileCard doctor={doctor} />
  );
  ...
  const columns: ColumnDef<Doctor>[] = [
    ...
    },
    {
      id: "clinic.name",
      label: "Klinik",
      accessor: (doctor) => doctor.clinic?.name || "-",
      sortable: true,
      width: 200,
    },
    {
      id: "username",
      label: "Username",
      accessor: (doctor) => doctor.username || "-",
      width: 150,
    },
  ];
